                ...
                <nav id="nav">
                    <ul class="nav list-unstyled clearfix">
                        <li data-section="#about">
							<a href="#about"><span class="glyphicon glyphicon-cog"></span> About</a>
						</li>
                        <li data-section="#projects">
							<a href="#projects"><span class="glyphicon glyphicon-cog"></span> Projects</a>
						</li>
                        <li data-section="#contact">
							<a href="#contact"><span class="glyphicon glyphicon-cog"></span> Contact</a>
						</li>
                    </ul>
                </nav>
            </div>
